"""
I didn't write this, this is from https://github.com/LmeSzinc/AzurLaneAutoScript
This is a tweaked version that will work when you ctrl c+v it into the base folder
"""
...
class DropStatistics(BattleStatusStatistics, GetItemsStatistics):
    ...
    def stat_drop(self, timestamp):
        ...
        data = [[timestamp, item.name, item.amount] for item in items]
        return data
...
Args:
    ...
    CSV_FILE: Csv file to save.
              Examples: 'c72.csv'
"""
FOLDER = R'L:\Code\Commission_autosort\Result'
CSV_FILE = 'data.csv'
